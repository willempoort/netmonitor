    ...
    def init_builtin_service_providers(self) -> int:
        ...
        builtin_providers = [
            ...
            # Cloud providers
            {
                ...
                'ip_ranges': [
                    '3.0.0.0/8', '15.177.0.0/16', '15.230.0.0/16',
                    '16.0.0.0/14', '18.0.0.0/13', '35.72.0.0/13',
                    '44.192.0.0/10', '52.0.0.0/11', '52.32.0.0/11',
                    '52.64.0.0/11', '52.94.0.0/15', '54.64.0.0/11',
                    '54.144.0.0/12', '54.160.0.0/11', '54.192.0.0/12',
                    '54.208.0.0/13', '54.224.0.0/12', '54.240.0.0/12',
                    '2600:1f00::/24'
                ]
            },
            {
                ...
                'category': 'cloud',
                'description': 'Microsoft Azure cloud platform and Microsoft 365',
                'ip_ranges': [
                    '13.64.0.0/11', '13.96.0.0/13', '13.104.0.0/14',
                    '20.0.0.0/11', '20.33.0.0/16', '20.34.0.0/15',
                    '20.36.0.0/14', '20.40.0.0/13', '20.48.0.0/12',
                    '20.64.0.0/10', '20.128.0.0/16', '40.64.0.0/10',
                    '51.104.0.0/15', '51.124.0.0/16', '52.96.0.0/12',
                    '52.112.0.0/14', '52.120.0.0/14', '52.132.0.0/14',
            ...
            },
            {
                ...
                'ip_ranges': [
                    ...
                    '23.251.128.0/19', '34.0.0.0/9', '34.128.0.0/10',
            ...
            },
            {
                ...
                'ip_ranges': [
                    '64.225.0.0/16', '128.199.0.0/16', '134.209.0.0/16',
                    ...
                    '161.35.0.0/16', '162.243.0.0/16', '164.90.0.0/16',
                    '164.92.0.0/16', '165.22.0.0/16', '165.227.0.0/16',
                    '167.71.0.0/16', '167.172.0.0/16', '167.99.0.0/16',
                    '174.138.0.0/16', '178.128.0.0/16', '188.166.0.0/16',
                    '206.189.0.0/16', '2400:6180::/32'
                ]
            },
            {
                'name': 'OVHcloud',
                'category': 'cloud',
                'description': 'OVHcloud European cloud hosting',
                'ip_ranges': [
                    '51.38.0.0/16', '51.68.0.0/16', '51.75.0.0/16',
                    '51.77.0.0/16', '51.79.0.0/16', '51.83.0.0/16',
                    '51.89.0.0/16', '51.91.0.0/16', '51.161.0.0/16',
                    '51.178.0.0/16', '51.195.0.0/16', '51.210.0.0/16',
                    '51.222.0.0/16', '54.36.0.0/16', '54.37.0.0/16',
                    '54.38.0.0/16', '91.121.0.0/16', '92.222.0.0/16',
                    '135.125.0.0/16', '141.94.0.0/16', '141.95.0.0/16',
                    '145.239.0.0/16', '146.59.0.0/16', '147.135.0.0/16',
            ...
            },
            {
                ...
                'ip_ranges': [
                    '5.9.0.0/16', '23.88.0.0/15', '46.4.0.0/16',
                    '49.12.0.0/14', '78.46.0.0/15', '88.99.0.0/16',
                    '88.198.0.0/16', '95.216.0.0/15', '116.202.0.0/15',
                    '128.140.0.0/16', '135.181.0.0/16', '136.243.0.0/16',
                    '138.201.0.0/16', '142.132.0.0/16', '148.251.0.0/16',
                    '157.90.0.0/16', '159.69.0.0/16', '162.55.0.0/16',
                    '167.233.0.0/16', '168.119.0.0/16', '176.9.0.0/16',
                    '178.63.0.0/16', '188.40.0.0/16', '195.201.0.0/16',
            ...
            # Social media
            {
                ...
                'ip_ranges': [
                    ...
                    '74.119.76.0/22', '102.132.96.0/20', '129.134.0.0/16',
                    '157.240.0.0/16', '163.70.128.0/17', '179.60.192.0/22',
            ...
            },
            {
                'name': 'Twitter/X',
                'category': 'social',
                'description': 'X (formerly Twitter) social platform',
                'ip_ranges': [
                    '69.195.160.0/19', '103.252.112.0/22', '104.244.40.0/21',
                    '185.45.4.0/22', '192.133.76.0/22', '199.16.156.0/22',
                    '199.59.148.0/22', '202.160.128.0/22',
                    '2400:6680::/32', '2606:1f80::/32'
                ]
            },
            {
                'name': 'LinkedIn',
                'category': 'social',
                'description': 'LinkedIn professional network (Microsoft)',
                'ip_ranges': [
                    '8.39.53.0/24', '91.225.248.0/22', '103.20.92.0/22',
                    '108.174.0.0/20', '144.2.0.0/16', '185.63.144.0/22',
                    '199.200.57.0/24', '216.52.16.0/20',
                    '2620:109:c000::/40'
                ]
            },
            {
                'name': 'TikTok',
                'category': 'social',
                'description': 'TikTok video platform (ByteDance)',
                'ip_ranges': [
                    '16.0.0.0/14', '19.0.0.0/8', '45.43.62.0/23',
                    '103.136.220.0/22', '111.13.128.0/22', '122.14.224.0/22',
                    '161.117.0.0/16', '170.33.0.0/16',
                    '2a09:bac0::/29'
                ]
            },
            {
                ...
                'ip_ranges': [
                    '34.82.0.0/15', '35.190.0.0/17', '64.233.160.0/19',
                    '66.102.0.0/20', '72.14.192.0/18', '74.125.0.0/16',
            ...
            # Gaming
            {
                ...
                'ip_ranges': [
                    '103.10.124.0/23', '103.28.54.0/23', '146.66.152.0/21',
                    '155.133.224.0/20', '162.254.192.0/21',
                    '185.25.180.0/22', '190.217.32.0/21', '192.69.96.0/22',
                    '205.196.6.0/24', '208.64.200.0/21', '208.78.164.0/22',
                    '2607:fcd0:100::/40'
                ]
            },
            {
                ...
                'category': 'gaming',
                'description': 'Xbox Live and Microsoft gaming services',
                'ip_ranges': [
                    '20.33.0.0/16', '20.40.0.0/13', '20.128.0.0/16',
            ...
            },
            {
                ...
                'category': 'gaming',
                'description': 'PlayStation Network gaming services',
                'ip_ranges': [
                    '103.1.168.0/22', '119.252.112.0/21', '204.14.16.0/21',
                    '204.98.158.0/23', '210.169.40.0/22'
                ]
            },
            {
                'name': 'Epic Games',
                'category': 'gaming',
                'description': 'Epic Games Store and Fortnite servers',
                'ip_ranges': [
                    '18.200.0.0/13', '34.192.0.0/10', '52.0.0.0/11',
                    '54.144.0.0/12', '99.80.0.0/14'
                ]
            },
            {
                'name': 'Riot Games',
                'category': 'gaming',
                'description': 'League of Legends en Valorant game servers',
                'ip_ranges': [
                    '43.229.64.0/22', '45.7.36.0/22', '64.7.192.0/18',
                    '66.150.148.0/22', '103.240.224.0/22', '104.160.128.0/17',
                    '162.249.72.0/21', '172.65.0.0/16', '185.40.64.0/22',
                    '192.64.168.0/22', '198.105.254.0/24'
                ]
            },
            {
                'name': 'Nintendo',
                ...
                'ip_ranges': [
                    '34.192.0.0/10', '52.0.0.0/11', '54.64.0.0/11',
                    '69.25.139.0/24', '175.184.192.0/20'
                ]
            },
        ]
        ...
        for provider_data in builtin_providers:
            if provider_data['name'] in existing_names:
                continue
