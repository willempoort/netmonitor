...
echo ""
echo "Next steps:"
echo "  1. Configure Netmonitor via Web UI: $DASHBOARD_BASE_URL"
echo "  2. Configure KIOSK mode rotation interval if needed"
echo "  3. Set up MCP server if using Claude Desktop integration"
echo ""
echo "Documentation:"
